...
<header id="site-header" role="banner">
  <div class="nav-inner">
    ...
    <a href="tel:<?php echo preg_replace('/\D/', '', sjioc_phone()); ?>" class="nav-phone-chip" aria-label="Call <?php echo esc_attr(sjioc_phone()); ?>">
      <svg viewBox="0 0 24 24" width="15" height="15" aria-hidden="true"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.86 11a19.79 19.79 0 01-3.07-8.67A2 2 0 012.77 0h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.91 8.59a16 16 0 006.5 6.5l1.95-1.35a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z" fill="var(--go)"/></svg>
    </a>
